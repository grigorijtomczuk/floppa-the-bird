...
{
	private PixelationFeature.CustomPassSettings settings;
	...
	public PixelationPass(PixelationFeature.CustomPassSettings settings)
	{
		this.settings = settings;
		this.renderPassEvent = settings.renderPassEvent;
		if (material == null) material = CoreUtils.CreateEngineMaterial("Hidden/Pixelation");
	}
